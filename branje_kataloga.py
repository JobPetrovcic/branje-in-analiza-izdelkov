...
VZOREC_STRANI = OSNOVA_SPAR_STRANI + \
    '/online/c/root/?_=1635264522253&callback=parseResponse&category=root&i=1&m_sortProdResults_egisp=a&page={stevilka_strani}&pos=81701&q=*&sort=product-ecr-sortlev&sp_cs=UTF-8&sp_q_12=81701&sp_q_exact_14=root&sp_x_12=product-visible-pos'
...
def shrani_stran_indeks(indeks):
    ...
    shrani_stran(VZOREC_STRANI.format(stevilka_strani=indeks),
                 dobi_ime_strani_indeks(indeks))
...
def je_povezava_do_produkta(povezava):
    """
    Z regex preverimo ali url ustreza vzorcu izdelka /online/tekst/p
    """
...
def poberi_povezave_do_produkta(html_objekt):
    """
    Iz kataloga pobere vse html povezave.
    """
...
def shrani_povezave_kataloga(nalozi_strani_iz_interneta=False):
    """
    Vse najdene povezave shrani v csv.
    """
